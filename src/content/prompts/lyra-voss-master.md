...
negativePrompt: "no red hair, no copper hair, no glowing armor, no exaggerated sci-fi armor, no high heels, no plastic skin"
whyItWorks: "Les constantes identitaires précèdent le lieu et le cadre. Les variables de plan peuvent changer sans réécrire Lyra."
variants: ["Portrait studio neutre", "Plan plein pied sous la pluie", "Vue de dos avec même tenue"]
lessonHref: "/formation/character-consistency/"
variables: ["shot scale", "lighting palette", "pose", "background depth"]
